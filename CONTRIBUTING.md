...
1. Confirm the build is [passing in travis](https://travis-ci.org/kaelig/SwiftApp)
...
2. Push a release commit
   ...
   2. Rename the old Master section like:
          ## [1.0.5](https://github.com/kaelig/SwiftApp/releases/tag/1.0.5)
